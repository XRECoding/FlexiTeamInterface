<script>
    ...
    function dfs(nodes, currentNodeId, horPosition, verPosition) {
        ...
        myDiagram.model.addNodeData({key: currentNodeId + "group", isGroup: true, category: "Auto", location: new go.Point(horPosition * 150, verPosition)});

        // Erstelle den Ellipse-Knoten innerhalb der Gruppe
        myDiagram.model.addNodeData({key: (currentNodeId + "data"), text: currentNode.data, category: "Ellipse", group: currentNodeId + "group"});

        // Erstelle den Rectangle-Knoten innerhalb der Gruppe
        myDiagram.model.addNodeData({key: currentNodeId, text: task, category: "Rectangle", group: currentNodeId + "group"});
        ...
        // Aktualisiere die vertikale Position
