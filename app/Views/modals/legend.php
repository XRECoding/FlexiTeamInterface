            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" value="Pre-Surgery" readonly>
                        </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" value="Resources" readonly>
                        </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            <span class="input-group-text" id="basic-addon1">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="pink" class="bi bi-circle-fill" viewBox="0 0 16 16">
                                    <circle cx="8" cy="8" r="8"></circle>
                                </svg>
                            </span>
                            <input type="text" class="form-control" value="Surgery" readonly>
                        </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" value="Post-Surgery" readonly>
                        </div>
                        </div>
                    </div>
                    <div class="col-md-6">
